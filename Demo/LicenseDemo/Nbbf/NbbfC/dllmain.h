...
------------------------------------------------------------------------------------------------- */
class CNbbfCModule : public CAtlDllModuleT< CNbbfCModule >
{
public :
	DECLARE_LIBID(LIBID_NbbfCLib)
	DECLARE_REGISTRY_APPID_RESOURCEID(IDR_NBBFC, "{8F887802-EC61-4FA9-BF96-ACC0A3ACF70C}")
};

extern class CNbbfCModule _AtlModule;
